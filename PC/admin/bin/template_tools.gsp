...
uses java.net.URL
uses gw.webservice.pc.pc900.templatetoolsapi.TemplateToolsAPI
...
config.ServerOverrideUrl = new URL(TemplateToolsArgs.Server + "/ws/gw/webservice/pc/pc900/TemplateToolsAPI").toURI() as String
