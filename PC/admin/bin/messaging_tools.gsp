...
uses java.net.URL
uses gw.webservice.pc.pc900.messagingtoolsapi.MessagingToolsAPI
...
config.ServerOverrideUrl = new URL(MessagingToolsArgs.Server + "/ws/gw/webservice/pc/pc900/MessagingToolsAPI").toURI() as String
