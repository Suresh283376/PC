  ...
  if( SystemToolsArgs.SqlServerPerfReport.length > 3) {
    ...
    try {
      if (SystemToolsArgs.SqlServerPerfReport.length == 3) {
        ...
        collectStatisticsParam = Boolean.parseBoolean(SystemToolsArgs.SqlServerPerfReport[2])
        ...
        try {
          ...
          collectStatisticsParam = Boolean.parseBoolean(SystemToolsArgs.SqlServerPerfReport[1])
        }
