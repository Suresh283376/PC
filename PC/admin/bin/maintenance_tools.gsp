...
uses gw.webservice.pc.pc900.maintenancetoolsapi.MaintenanceToolsAPI
uses gw.webservice.pc.pc900.maintenancetoolsapi.types.complex.ProcessID
...
config.ServerOverrideUrl = new URL(MaintenanceToolsArgs.Server + "/ws/gw/webservice/pc/pc900/MaintenanceToolsAPI").toURI() as String
