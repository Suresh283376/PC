...
class SubmissionProcess extends NewTermProcess {
  ...
  protected final var _ilElement: ILElement as ILElement = ILElement.of(
      ILElementIdentifier.of(ILElementType.TC_JOB,"SubmissionProcess"),
      PCLoggingMarker.SUBMISSION_PROCESS
  )
  ...
  function failBinding() {
    ...
    JobProcessContextUpdater.updateContext(_branch)
    IntentionalLogger.logFail(ILElement,DisplayKey.get("Submission.BindSubmission.Failed.Activity.Subject"))
    JobProcessContextUpdater.clearContext()
  }
  ...
  function failIssuing() {
    ...
    JobProcessContextUpdater.updateContext(_branch)
    IntentionalLogger.logFail(ILElement,DisplayKey.get("Issuance.IssuePolicy.Failed.Subject"))
    JobProcessContextUpdater.clearContext()
  }
