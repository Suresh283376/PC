...
uses gw.api.intentionallogging.*
...
class IssuanceProcess extends JobProcess {
  ...
  private final var _ilElement : ILElement as ILElement = ILElement.of(
      ILElementIdentifier.of(ILElementType.TC_JOB, "IssuanceProcess"),
      PCLoggingMarker.ISSUANCE_PROCESS
  );
  ...
  function finishIssuing() {
    ...
    IntentionalLogger.logResult(
        ...
        LogMessageParams.create()
            .put("result.outcome", BindOption.TC_BINDANDISSUE)
