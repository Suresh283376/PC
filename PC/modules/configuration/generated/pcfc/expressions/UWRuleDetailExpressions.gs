...
class UWRuleDetailExpressions {
  ...
  public static class UWRuleDetailExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function __constructorIndex (head :  RuleHead, version :  RuleVersion) : int {
      return 0
    }
    
    // 'action' attribute on AlertBar (id=NotLatestAlert) at UWRuleDetail.pcf: line 58, column 57
    function action_20 () : void {
      stateHolder.SelectedVersion = stateHolder.Head.HeadVersion
    }
    
    // 'action' attribute on AlertBar (id=UnavailableToRunAlert) at UWRuleDetail.pcf: line 66, column 181
    function action_23 () : void {
      stateHolder.makeLatestVersionAvailableToRunInNewBundle()
    }
    
    // 'action' attribute on AlertBar (id=PendingImportAlert) at UWRuleDetail.pcf: line 72, column 49
    function action_26 () : void {
      RuleImportDetailsPopup.push(stateHolder.NavigationSupport, stateHolder.Head.InProgressImportTaskEntry.Task, false)
    }
    
    // 'action' attribute on AlertBar (id=DuplicatedNameAlertBar) at UWRuleDetail.pcf: line 78, column 140
    function action_29 () : void {
      stateHolder.VersionController.pushRulesWithSameNamePopup(head.HeadVersion)
    }
    
    // 'action' attribute on AlertBar (id=RuleDeletedByAnotherUserAlert) at UWRuleDetail.pcf: line 85, column 52
    ...
    // 'available' attribute on AlertBar (id=UnavailableToRunAlert) at UWRuleDetail.pcf: line 66, column 181
    ...
    // 'available' attribute on ToolbarRangeInput (id=Version_Input) at UWRuleDetail.pcf: line 43, column 49
    function available_6 () : java.lang.Boolean {
      return !CurrentLocation.InEditMode
    }
    
    // 'def' attribute on PanelRef at UWRuleDetail.pcf: line 93, column 56
    ...
    // 'value' attribute on ToolbarRangeInput (id=Version_Input) at UWRuleDetail.pcf: line 43, column 49
    ...
    // 'initialValue' attribute on Variable at UWRuleDetail.pcf: line 24, column 60
    ...
    // 'label' attribute on AlertBar (id=UnavailableToRunAlert) at UWRuleDetail.pcf: line 66, column 181
    ...
    // 'label' attribute on AlertBar (id=RuleIsNotManagedByBusinessRulesFrameworkAlert) at UWRuleDetail.pcf: line 90, column 83
    function label_33 () : java.lang.Object {
      return stateHolder.ExternallyManagedAlert
    }
    
    // 'optionLabel' attribute on ToolbarRangeInput (id=Version_Input) at UWRuleDetail.pcf: line 43, column 49
    ...
    static function parent_40 (head :  RuleHead, version :  RuleVersion) : pcf.api.Destination {
      return pcf.UWRules.createDestination()
    }
    
    // 'title' attribute on Page (id=UWRuleDetail) at UWRuleDetail.pcf: line 12, column 101
    static function title_41 (head :  RuleHead, version :  RuleVersion) : java.lang.Object {
      return DisplayKey.get("Web.BizRules.UWRuleDetail.Title", head.HeadVersion.Rule.Name)
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at UWRuleDetail.pcf: line 28, column 77
    function toolbarButtonSet_onEnter_1 (def :  pcf.StatusTransitionToolbarButtonSet) : void {
      def.onEnter(stateHolder)
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at UWRuleDetail.pcf: line 31, column 50
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=Version_Input) at UWRuleDetail.pcf: line 43, column 49
    ...
    // 'visible' attribute on AlertBar (id=RollingUpgradeAlert) at UWRuleDetail.pcf: line 51, column 240
    ...
    // 'visible' attribute on AlertBar (id=NotLatestAlert) at UWRuleDetail.pcf: line 58, column 57
    function visible_19 () : java.lang.Boolean {
      return stateHolder.NotLatestVersionSelected
    }
    
    // 'visible' attribute on AlertBar (id=UnavailableToRunAlert) at UWRuleDetail.pcf: line 66, column 181
    ...
    // 'visible' attribute on AlertBar (id=PendingImportAlert) at UWRuleDetail.pcf: line 72, column 49
    function visible_25 () : java.lang.Boolean {
      return stateHolder.ImportInProgress
    }
    
    // 'visible' attribute on AlertBar (id=DuplicatedNameAlertBar) at UWRuleDetail.pcf: line 78, column 140
    ...
    // 'visible' attribute on ToolbarButtonSetRef at UWRuleDetail.pcf: line 31, column 50
    function visible_3 () : java.lang.Boolean {
      return stateHolder.doesHeadExist()
    }
    
    // 'visible' attribute on AlertBar (id=RuleDeletedByAnotherUserAlert) at UWRuleDetail.pcf: line 85, column 52
    function visible_30 () : java.lang.Boolean {
      return not stateHolder.doesHeadExist()
    }
    
    // 'visible' attribute on AlertBar (id=RuleIsNotManagedByBusinessRulesFrameworkAlert) at UWRuleDetail.pcf: line 90, column 83
    function visible_32 () : java.lang.Boolean {
      return (stateHolder.SelectedVersion.Rule as UWRule).ExternallyManaged
    }
    
    // 'visible' attribute on PanelRef at UWRuleDetail.pcf: line 93, column 56
