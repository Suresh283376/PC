...
class RateBookDetailsScreenExpressions {
  ...
  public static class RateBookDetailsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function value_175 () : entity.RateTable[] {
      return rateBook != null ? rateBook.SelectedRateTables.orderBy(\ rt -> rt.Definition.TableName).toTypedArray() : gw.api.upgrade.Coercions.makeArray<entity.RateTable>(java.util.Collections.EMPTY_LIST)
    }
