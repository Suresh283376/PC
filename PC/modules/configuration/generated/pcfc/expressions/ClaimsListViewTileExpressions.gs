...
class ClaimsListViewTileExpressions {
  ...
  public static class ClaimsListViewTileExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function initialValue_45 () : gw.api.web.dashboard.ui.claims.ClaimHelper {
      return gw.api.web.dashboard.ui.claims.ClaimHelper.forContact(contact)
    }
    
    // 'value' attribute on TextCell (id=ClaimNumber_Cell) at ClaimsListViewTile.pcf: line 31, column 25
    function sortValue_0 (claim :  gw.api.web.dashboard.data.claims.ClaimDTO) : java.lang.Object {
      return claim.ClaimNumber
    }
    
    // 'value' attribute on TextCell (id=Status_Cell) at ClaimsListViewTile.pcf: line 37, column 25
    function sortValue_1 (claim :  gw.api.web.dashboard.data.claims.ClaimDTO) : java.lang.Object {
      return claim.Status
    }
    
    // 'value' attribute on DateCell (id=LossDate_Cell) at ClaimsListViewTile.pcf: line 42, column 25
    function sortValue_2 (claim :  gw.api.web.dashboard.data.claims.ClaimDTO) : java.lang.Object {
      return claim.LossDate
    }
    
    // 'value' attribute on TextCell (id=LossType_Cell) at ClaimsListViewTile.pcf: line 47, column 35
    ...
    // 'value' attribute on MonetaryAmountCell (id=TotalIncurred_Cell) at ClaimsListViewTile.pcf: line 68, column 25
    function sortValue_7 (claim :  gw.api.web.dashboard.data.claims.ClaimDTO) : java.lang.Object {
      return claim.TotalIncurred
    }
    
    // 'value' attribute on TextCell (id=InsuredName_Cell) at ClaimsListViewTile.pcf: line 73, column 38
    function sortValue_8 (claim :  gw.api.web.dashboard.data.claims.ClaimDTO) : java.lang.Object {
      return claim.InsuredName
    }
    
    // 'value' attribute on TextCell (id=Adjuster_Cell) at ClaimsListViewTile.pcf: line 78, column 63
    ...
    function value_44 () : gw.api.web.dashboard.data.claims.ClaimDTO[] {
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimsListViewTileExpressionsImpl {
    ...
    // 'actionAvailable' attribute on TextCell (id=ClaimNumber_Cell) at ClaimsListViewTile.pcf: line 31, column 25
    function actionAvailable_12 () : java.lang.Boolean {
      return claimHelper.isViewInClaimSystemLinkAvailable(claim)
    }
    
    // 'action' attribute on TextCell (id=ClaimNumber_Cell) at ClaimsListViewTile.pcf: line 31, column 25
