...
class QuickSubmission_QuoteScreenExpressions {
  ...
  public static class QuickSubmission_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=RequoteButton_Input) at QuickSubmission_QuoteScreen.pcf: line 98, column 54
    ...
    // 'def' attribute on PanelRef at QuickSubmission_QuoteScreen.pcf: line 103, column 44
    function def_onEnter_54 (def :  pcf.QuickSubmission_QuoteDetailsPanelSet_PersonalAutoLine) : void {
      def.onEnter(policyPeriod, jobWizardHelper, openForEdit)
    }
    
    // 'def' attribute on PanelRef at QuickSubmission_QuoteScreen.pcf: line 103, column 44
    function def_onEnter_56 (def :  pcf.QuickSubmission_QuoteDetailsPanelSet_default) : void {
      def.onEnter(policyPeriod, jobWizardHelper, openForEdit)
    }
    ...
    // 'def' attribute on PanelRef at QuickSubmission_QuoteScreen.pcf: line 103, column 44
    function def_refreshVariables_55 (def :  pcf.QuickSubmission_QuoteDetailsPanelSet_PersonalAutoLine) : void {
      def.refreshVariables(policyPeriod, jobWizardHelper, openForEdit)
    }
    
    // 'def' attribute on PanelRef at QuickSubmission_QuoteScreen.pcf: line 103, column 44
    function def_refreshVariables_57 (def :  pcf.QuickSubmission_QuoteDetailsPanelSet_default) : void {
      def.refreshVariables(policyPeriod, jobWizardHelper, openForEdit)
    }
    ...
    // 'mode' attribute on PanelRef at QuickSubmission_QuoteScreen.pcf: line 103, column 44
    ...
    // 'title' attribute on TitleBar at QuickSubmission_QuoteScreen.pcf: line 106, column 74
    function title_53 () : java.lang.String {
    ...
    // 'visible' attribute on ButtonInput (id=RequoteButton_Input) at QuickSubmission_QuoteScreen.pcf: line 98, column 54
    function visible_48 () : java.lang.Boolean {
      return not (policyPeriod.ValidQuote)
    }
    
    // 'visible' attribute on TitleBar at QuickSubmission_QuoteScreen.pcf: line 106, column 74
