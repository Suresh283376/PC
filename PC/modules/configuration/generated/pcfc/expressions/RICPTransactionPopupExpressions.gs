...
class RICPTransactionPopupExpressions {
  ...
  public static class RICPTransactionPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=CalculationOrder_Input) at RICPTransactionPopup.pcf: line 61, column 44
    function value_24 () : java.lang.Integer {
      return transaction.CalculationOrder
    }
    
    // 'value' attribute on MonetaryAmountInput (id=CededRiskAmount_Input) at RICPTransactionPopup.pcf: line 66, column 50
    ...
    // 'value' attribute on MonetaryAmountInput (id=BasisGNP_Input) at RICPTransactionPopup.pcf: line 71, column 43
    function value_30 () : gw.pl.currency.MonetaryAmount {
      return transaction.BasisGNP
    }
    
    // 'value' attribute on MonetaryAmountInput (id=CededPremium_Input) at RICPTransactionPopup.pcf: line 76, column 47
    function value_33 () : gw.pl.currency.MonetaryAmount {
      return transaction.CededPremium
    }
    
    // 'value' attribute on MonetaryAmountInput (id=Commission_Input) at RICPTransactionPopup.pcf: line 81, column 45
    function value_36 () : gw.pl.currency.MonetaryAmount {
      return transaction.Commission
    }
    
    // 'value' attribute on MonetaryAmountInput (id=CededPremiumMarkup_Input) at RICPTransactionPopup.pcf: line 86, column 53
    function value_39 () : gw.pl.currency.MonetaryAmount {
      return transaction.CededPremiumMarkup
    }
    
    // 'value' attribute on DateInput (id=ExpirationDate_Input) at RICPTransactionPopup.pcf: line 90, column 49
    function value_42 () : java.util.Date {
      return transaction.ExpirationDate
    }
    
    // 'value' attribute on DateInput (id=DateWritten_Input) at RICPTransactionPopup.pcf: line 94, column 46
