...
class RateRoutineEditScreenExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends RateRoutineEditScreenExpressionsImpl {
    ...
    // 'available' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function available_50 () : java.lang.Boolean {
      return helper.operatorAvailable(ratingRoutineStep)
    }
    
    // 'checkBoxVisible' attribute on RowIterator (id=RatingRoutineActions) at RateRoutineEditScreen.pcf: line 259, column 75
    function checkBoxVisible_181 () : java.lang.Boolean {
      return not helper.isStepInLoopBlock(ratingRoutineStep) or helper.stepStartsLoopBlock(ratingRoutineStep)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    function def_onEnter_115 (def :  pcf.RateRoutineStepEditOperand_constant) : void {
      def.onEnter(ratingRoutineStep, rateRoutine, inScopeParamInScopeUsageMap, costDataUsages, orderedSteps)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    function def_onEnter_117 (def :  pcf.RateRoutineStepEditOperand_default) : void {
      def.onEnter(ratingRoutineStep, rateRoutine, inScopeParamInScopeUsageMap, costDataUsages, orderedSteps)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    function def_onEnter_119 (def :  pcf.RateRoutineStepEditOperand_rounding) : void {
      def.onEnter(ratingRoutineStep, rateRoutine, inScopeParamInScopeUsageMap, costDataUsages, orderedSteps)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_onEnter_139 (def :  pcf.RateRoutineStepEditInstruction_assignment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_onEnter_141 (def :  pcf.RateRoutineStepEditInstruction_comment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_onEnter_143 (def :  pcf.RateRoutineStepEditInstruction_default) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_onEnter_145 (def :  pcf.RateRoutineStepEditInstruction_flowcontrol) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_onEnter_147 (def :  pcf.RateRoutineStepEditInstruction_inscope) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_onEnter_149 (def :  pcf.RateRoutineStepEditInstruction_voidfunction) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_onEnter_161 (def :  pcf.RateRoutineStepEditInstruction_assignment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_onEnter_163 (def :  pcf.RateRoutineStepEditInstruction_comment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_onEnter_165 (def :  pcf.RateRoutineStepEditInstruction_default) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_onEnter_167 (def :  pcf.RateRoutineStepEditInstruction_flowcontrol) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_onEnter_169 (def :  pcf.RateRoutineStepEditInstruction_inscope) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_onEnter_171 (def :  pcf.RateRoutineStepEditInstruction_voidfunction) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_onEnter_40 (def :  pcf.RateRoutineStepInstruction_assignment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_onEnter_42 (def :  pcf.RateRoutineStepInstruction_default) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_onEnter_44 (def :  pcf.RateRoutineStepInstruction_flowcontrol) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_onEnter_46 (def :  pcf.RateRoutineStepInstruction_voidfunction) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_onEnter_81 (def :  pcf.RateRoutineStepEditInstruction_assignment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_onEnter_83 (def :  pcf.RateRoutineStepEditInstruction_comment) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_onEnter_85 (def :  pcf.RateRoutineStepEditInstruction_default) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_onEnter_87 (def :  pcf.RateRoutineStepEditInstruction_flowcontrol) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_onEnter_89 (def :  pcf.RateRoutineStepEditInstruction_inscope) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_onEnter_91 (def :  pcf.RateRoutineStepEditInstruction_voidfunction) : void {
      def.onEnter(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    function def_refreshVariables_116 (def :  pcf.RateRoutineStepEditOperand_constant) : void {
      def.refreshVariables(ratingRoutineStep, rateRoutine, inScopeParamInScopeUsageMap, costDataUsages, orderedSteps)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    function def_refreshVariables_118 (def :  pcf.RateRoutineStepEditOperand_default) : void {
      def.refreshVariables(ratingRoutineStep, rateRoutine, inScopeParamInScopeUsageMap, costDataUsages, orderedSteps)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    function def_refreshVariables_120 (def :  pcf.RateRoutineStepEditOperand_rounding) : void {
      def.refreshVariables(ratingRoutineStep, rateRoutine, inScopeParamInScopeUsageMap, costDataUsages, orderedSteps)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_refreshVariables_140 (def :  pcf.RateRoutineStepEditInstruction_assignment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_refreshVariables_142 (def :  pcf.RateRoutineStepEditInstruction_comment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_refreshVariables_144 (def :  pcf.RateRoutineStepEditInstruction_default) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_refreshVariables_146 (def :  pcf.RateRoutineStepEditInstruction_flowcontrol) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_refreshVariables_148 (def :  pcf.RateRoutineStepEditInstruction_inscope) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionCommentRow) at RateRoutineEditScreen.pcf: line 382, column 80
    function def_refreshVariables_150 (def :  pcf.RateRoutineStepEditInstruction_voidfunction) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_refreshVariables_162 (def :  pcf.RateRoutineStepEditInstruction_assignment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_refreshVariables_164 (def :  pcf.RateRoutineStepEditInstruction_comment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_refreshVariables_166 (def :  pcf.RateRoutineStepEditInstruction_default) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_refreshVariables_168 (def :  pcf.RateRoutineStepEditInstruction_flowcontrol) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_refreshVariables_170 (def :  pcf.RateRoutineStepEditInstruction_inscope) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstructionVoidFunctionRow) at RateRoutineEditScreen.pcf: line 401, column 80
    function def_refreshVariables_172 (def :  pcf.RateRoutineStepEditInstruction_voidfunction) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_refreshVariables_41 (def :  pcf.RateRoutineStepInstruction_assignment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_refreshVariables_43 (def :  pcf.RateRoutineStepInstruction_default) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_refreshVariables_45 (def :  pcf.RateRoutineStepInstruction_flowcontrol) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function def_refreshVariables_47 (def :  pcf.RateRoutineStepInstruction_voidfunction) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_refreshVariables_82 (def :  pcf.RateRoutineStepEditInstruction_assignment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_refreshVariables_84 (def :  pcf.RateRoutineStepEditInstruction_comment) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_refreshVariables_86 (def :  pcf.RateRoutineStepEditInstruction_default) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_refreshVariables_88 (def :  pcf.RateRoutineStepEditInstruction_flowcontrol) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_refreshVariables_90 (def :  pcf.RateRoutineStepEditInstruction_inscope) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'def' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function def_refreshVariables_92 (def :  pcf.RateRoutineStepEditInstruction_voidfunction) : void {
      def.refreshVariables(ratingRoutineStep, helper, indentLevelMap, writableParamUsages, writableParams, costDataUsages)
    }
    
    // 'value' attribute on TextCell (id=LeftParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 351, column 78
    ...
    // 'value' attribute on TextCell (id=RightParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 363, column 78
    ...
    // 'value' attribute on TextCell (id=StepNote_Cell) at RateRoutineEditScreen.pcf: line 370, column 78
    ...
    // 'value' attribute on TextAreaCell (id=SectionComment_Cell) at RateRoutineEditScreen.pcf: line 389, column 61
    ...
    // 'value' attribute on RangeCell (id=StepOperator_Cell) at RateRoutineEditScreen.pcf: line 341, column 125
    ...
    // 'editable' attribute on TextCell (id=LeftParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 351, column 78
    ...
    // 'filter' attribute on RangeCell (id=StepOperator_Cell) at RateRoutineEditScreen.pcf: line 341, column 125
    function filter_100 (VALUE :  typekey.CalcStepOperatorType, VALUES :  typekey.CalcStepOperatorType[]) : java.lang.Boolean {
      return mainColumnOperators.contains(VALUE)
    }
    
    // 'filter' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function filter_54 (VALUE :  typekey.CalcStepOperatorType, VALUES :  typekey.CalcStepOperatorType[]) : java.lang.Boolean {
      return (CalcStepOperatorType.Type as gw.entity.ITypeList).getTypeKeysByFilterName("MainColumnOperators").contains(VALUE)
    }
    
    // 'highlighted' attribute on Row at RateRoutineEditScreen.pcf: line 319, column 164
    function highlighted_136 () : java.lang.Boolean {
      return highlightedRows.containsKey(ratingRoutineStep)
    }
    
    // 'mode' attribute on ModalCellRef (id=RateRoutineOperand) at RateRoutineEditScreen.pcf: line 356, column 123
    ...
    // 'mode' attribute on ModalCellRef (id=RateRoutineStepInstruction) at RateRoutineEditScreen.pcf: line 274, column 108
    function mode_48 () : java.lang.Object {
      return ratingRoutineStep.StepType.Categories.whereTypeIs(CalcStepCategory).first().Code
    }
    
    // 'mode' attribute on ModalCellRef (id=RateRoutineInstruction) at RateRoutineEditScreen.pcf: line 327, column 80
    function mode_93 () : java.lang.Object {
      return helper.getStepEditInstructionMode(ratingRoutineStep)
    }
    
    // 'onChange' attribute on PostOnChange at RateRoutineEditScreen.pcf: line 290, column 90
    function onChange_49 () : void {
      helper.updateOperandForOperatorChange(ratingRoutineStep)
    }
    
    // 'onChange' attribute on PostOnChange at RateRoutineEditScreen.pcf: line 343, column 90
    function onChange_94 () : void {
      helper.updateOperandForOperatorChange(ratingRoutineStep)
    }
    
    // 'optionLabel' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function optionLabel_55 (VALUE :  typekey.CalcStepOperatorType) : java.lang.String {
      return VALUE.LabelForDisplay
    }
    
    // 'outputConversion' attribute on TextAreaCell (id=SectionComment_Cell) at RateRoutineEditScreen.pcf: line 389, column 61
    function outputConversion_152 (VALUE :  java.lang.String) : java.lang.String {
      return rateRoutine.indentValue(ratingRoutineStep, VALUE, indentLevelMap)
    }
    
    // 'requestValidationExpression' attribute on TextCell (id=LoopBlockLeftParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 298, column 31
    function requestValidationExpression_62 (VALUE :  java.lang.String) : java.lang.Object {
      return VALUE.toCharArray().toList().countWhere(\ c -> c != '(') == 0 ? null: DisplayKey.get("Web.Rating.Flow.CalcRoutine.OnlyLeftParenthesisHere")
    }
    
    // 'requestValidationExpression' attribute on TextCell (id=LoopBlockRightParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 309, column 31
    function requestValidationExpression_70 (VALUE :  java.lang.String) : java.lang.Object {
    ...
    // 'valueRange' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function valueRange_56 () : java.lang.Object {
      return CalcStepOperatorType.getTypeKeys(false)
    }
    
    // 'value' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function valueRoot_53 () : java.lang.Object {
      return ratingRoutineStep.PrimaryOperand
    }
    
    // 'value' attribute on TextCell (id=LoopBlockStepNote_Cell) at RateRoutineEditScreen.pcf: line 315, column 78
    ...
    // 'value' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function value_52 () : typekey.CalcStepOperatorType {
      return ratingRoutineStep.PrimaryOperand.OperatorType
    }
    
    // 'value' attribute on TextCell (id=LoopBlockLeftParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 298, column 31
    function value_63 () : java.lang.String {
      return ratingRoutineStep.PrimaryOperand.LeftParenthesisGroup
    }
    
    // 'value' attribute on TextCell (id=ActionOperand_Cell) at RateRoutineEditScreen.pcf: line 302, column 73
    function value_66 () : java.lang.String {
      return ratingRoutineStep.PrimaryOperand.OperandName
    }
    
    // 'value' attribute on TextCell (id=LoopBlockRightParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 309, column 31
    ...
    // 'value' attribute on TextCell (id=RateRoutineStepError_Cell) at RateRoutineEditScreen.pcf: line 322, column 151
    ...
    // 'valueRange' attribute on RangeCell (id=StepOperator_Cell) at RateRoutineEditScreen.pcf: line 341, column 125
    function verifyValueRangeIsAllowedType_103 ($$arg :  java.util.List) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeCell (id=StepOperator_Cell) at RateRoutineEditScreen.pcf: line 341, column 125
    function verifyValueRangeIsAllowedType_103 ($$arg :  typekey.CalcStepOperatorType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'valueRange' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function verifyValueRangeIsAllowedType_57 ($$arg :  typekey.CalcStepOperatorType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on Row at RateRoutineEditScreen.pcf: line 319, column 164
    ...
    // 'visible' attribute on Row at RateRoutineEditScreen.pcf: line 374, column 118
    ...
    // 'visible' attribute on Row at RateRoutineEditScreen.pcf: line 393, column 116
    ...
    // 'valueVisible' attribute on RangeCell (id=ActionOperator_Cell) at RateRoutineEditScreen.pcf: line 288, column 30
    function visible_51 () : java.lang.Boolean {
      return helper.operatorAvailable(ratingRoutineStep) and not ratingRoutineStep.IsSectionCommentStep
    }
    
    // 'valueVisible' attribute on TextCell (id=LoopBlockLeftParenthesisGroup_Cell) at RateRoutineEditScreen.pcf: line 298, column 31
    function visible_61 () : java.lang.Boolean {
      return not ratingRoutineStep.IsSectionCommentStep
    }
    
    // 'visible' attribute on Row at RateRoutineEditScreen.pcf: line 265, column 160
  ...
  public static class RateRoutineEditScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=ValidateButton) at RateRoutineEditScreen.pcf: line 214, column 29
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=MoveUp) at RateRoutineEditScreen.pcf: line 200, column 44
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=MoveDown) at RateRoutineEditScreen.pcf: line 206, column 44
    ...
    // 'label' attribute on ToolbarButton (id=ValidateButton) at RateRoutineEditScreen.pcf: line 214, column 29
    ...
    // 'startChecked' attribute on RowIterator (id=RatingRoutineActions) at RateRoutineEditScreen.pcf: line 259, column 75
    ...
    // 'toRemove' attribute on RowIterator (id=RatingRoutineActions) at RateRoutineEditScreen.pcf: line 259, column 75
    function toRemove_182 (ratingRoutineStep :  entity.CalcStepDefinition) : void {
      currentSection = helper.removeRow(ratingRoutineStep, currentSection)
    }
    ...
    // 'value' attribute on RowIterator (id=RatingRoutineActions) at RateRoutineEditScreen.pcf: line 259, column 75
