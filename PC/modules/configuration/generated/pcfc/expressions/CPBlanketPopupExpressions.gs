...
class CPBlanketPopupExpressions {
  ...
  public static class CPBlanketPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Limit_Cell) at CPBlanketPopup.pcf: line 171, column 74
    ...
    // 'value' attribute on TextCell (id=Deductible_Cell) at CPBlanketPopup.pcf: line 175, column 75
    ...
    // 'value' attribute on TextCell (id=Coinsurance_Cell) at CPBlanketPopup.pcf: line 179, column 80
    ...
    // 'value' attribute on TextCell (id=Status_Cell) at CPBlanketPopup.pcf: line 183, column 67
