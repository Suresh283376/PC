...
class HandlePreemptionPopupExpressions {
  ...
  public static class HandlePreemption_DifferencesScreenExpressionsImpl extends HandlePreemptionPopupExpressionsImpl {
    ...
    // 'label' attribute on Verbatim at HandlePreemptionPopup.pcf: line 58, column 220
    function label_8 () : java.lang.String {
      return allowWithdraw ? DisplayKey.get("Web.HandlePreemption.Message", policyPeriod.Job.DisplayType) : DisplayKey.get("Web.HandlePreemption.MessageNoWithdraw", policyPeriod.Job.DisplayType)
    }
