...
class MyActivitiesListViewTileExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends MyActivitiesListViewTileExpressionsImpl {
    ...
    // 'action' attribute on ButtonCell (id=CompleteButton_Cell) at MyActivitiesListViewTile.pcf: line 87, column 80
    ...
    // 'available' attribute on ButtonCell (id=CompleteButton_Cell) at MyActivitiesListViewTile.pcf: line 87, column 80
    ...
    // 'value' attribute on TextCell (id=Product_Cell) at MyActivitiesListViewTile.pcf: line 82, column 56
