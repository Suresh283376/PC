...
class ImpactTestingSearchPoliciesPanelSetExpressions {
  ...
  public static class ImpactTestingSearchPoliciesPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=resultPolicyNumber_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 28, column 29
    function sortValue_0 (policyPeriod :  entity.PolicyPeriod) : java.lang.Object {
      return policyPeriod.PolicyNumberDisplayString
    }
    
    // 'value' attribute on TextCell (id=resultPolicyTerm_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 34, column 29
    function sortValue_1 (policyPeriod :  entity.PolicyPeriod) : java.lang.Object {
      return policyPeriod.TermNumber
    }
    
    // 'value' attribute on TextCell (id=resultProducerCode_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 46, column 29
    function sortValue_2 (policyPeriod :  entity.PolicyPeriod) : java.lang.Object {
      return policyPeriod.ProducerCodeOfRecord
    }
    
    // 'value' attribute on TypeKeyCell (id=resultJurisdiction_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 52, column 29
    function sortValue_3 (policyPeriod :  entity.PolicyPeriod) : java.lang.Object {
      return policyPeriod.BaseState
    }
    
    // 'value' attribute on DateCell (id=resultExpirationDate_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 64, column 29
    function sortValue_4 (policyPeriod :  entity.PolicyPeriod) : java.lang.Object {
      return policyPeriod.PeriodStart
    }
    
    // 'value' attribute on DateCell (id=resultEffectiveDate_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 69, column 29
    function sortValue_5 (policyPeriod :  entity.PolicyPeriod) : java.lang.Object {
      return policyPeriod.PeriodEnd
    }
    
    // 'value' attribute on RowIterator at ImpactTestingSearchPoliciesPanelSet.pcf: line 22, column 83
  ...
  public static class IteratorEntryExpressionsImpl extends ImpactTestingSearchPoliciesPanelSetExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=resultPostalCode_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 59, column 29
    ...
    // 'value' attribute on TextCell (id=resultProduct_Cell) at ImpactTestingSearchPoliciesPanelSet.pcf: line 40, column 114
