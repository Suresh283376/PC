...
class PolicyChange_ChangeEditEffectiveDateExpressions {
  ...
  public static class PolicyChange_ChangeEditEffectiveDateExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'afterCancel' attribute on Page (id=PolicyChange_ChangeEditEffectiveDate) at PolicyChange_ChangeEditEffectiveDate.pcf: line 15, column 78
    ...
    // 'afterCommit' attribute on Page (id=PolicyChange_ChangeEditEffectiveDate) at PolicyChange_ChangeEditEffectiveDate.pcf: line 15, column 78
    function afterCommit_13 (TopLocation :  pcf.api.Location) : void {
      JobForward.go(policyChange)
    }
    
    // 'afterEnter' attribute on Page (id=PolicyChange_ChangeEditEffectiveDate) at PolicyChange_ChangeEditEffectiveDate.pcf: line 15, column 78
    function afterEnter_14 () : void {
      gw.api.web.AutoSaveCacheGateway.clearUnsavedWork()
    }
    
    // 'beforeCommit' attribute on Page (id=PolicyChange_ChangeEditEffectiveDate) at PolicyChange_ChangeEditEffectiveDate.pcf: line 15, column 78
    ...
    // 'value' attribute on DateInput (id=EffectiveDate_Input) at PolicyChange_ChangeEditEffectiveDate.pcf: line 48, column 35
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      effectiveDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at PolicyChange_ChangeEditEffectiveDate.pcf: line 55, column 47
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      policyChange.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'initialValue' attribute on Variable at PolicyChange_ChangeEditEffectiveDate.pcf: line 27, column 30
    function initialValue_0 () : java.util.Date {
      return policyPeriod.EditEffectiveDate
    }
    
    // 'parent' attribute on Page (id=PolicyChange_ChangeEditEffectiveDate) at PolicyChange_ChangeEditEffectiveDate.pcf: line 15, column 78
    static function parent_16 (policyChange :  PolicyChange, policyPeriod :  PolicyPeriod) : pcf.api.Destination {
      return pcf.JobForward.createDestination(policyChange)
    }
    
    // 'validationExpression' attribute on DateInput (id=EffectiveDate_Input) at PolicyChange_ChangeEditEffectiveDate.pcf: line 48, column 35
