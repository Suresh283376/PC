...
class ArchivedPolicyPeriodPageExpressions {
  ...
  public static class ArchivedPolicyPeriodPageExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_26 (policyPeriod :  PolicyPeriod) : java.lang.Boolean {
    ...
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 49, column 64
    function def_onEnter_15 (def :  pcf.CompletedPolicyTransactionsListViewTile) : void {
      def.onEnter(policyPeriod, asOfDate)
    }
    
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 54, column 44
    function def_onEnter_18 (def :  pcf.AccountDetailViewTile) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 57, column 62
    function def_onEnter_21 (def :  pcf.NotesDetailViewTile) : void {
      def.onEnter(gw.api.web.dashboard.ui.note.NoteHelper.forPolicyPeriod(policyPeriod, asOfDate))
    }
    
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 60, column 45
    function def_onEnter_24 (def :  pcf.ProducerDetailViewTile) : void {
      def.onEnter(policyPeriod)
    }
    ...
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 49, column 64
    function def_refreshVariables_16 (def :  pcf.CompletedPolicyTransactionsListViewTile) : void {
      def.refreshVariables(policyPeriod, asOfDate)
    }
    
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 54, column 44
    function def_refreshVariables_19 (def :  pcf.AccountDetailViewTile) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 57, column 62
    function def_refreshVariables_22 (def :  pcf.NotesDetailViewTile) : void {
      def.refreshVariables(gw.api.web.dashboard.ui.note.NoteHelper.forPolicyPeriod(policyPeriod, asOfDate))
    }
    
    // 'def' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 60, column 45
    function def_refreshVariables_25 (def :  pcf.ProducerDetailViewTile) : void {
      def.refreshVariables(policyPeriod)
    }
    ...
    static function parent_27 (policyPeriod :  PolicyPeriod) : pcf.api.Destination {
    ...
    static function title_28 (policyPeriod :  PolicyPeriod) : java.lang.Object {
    ...
    // 'visible' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 49, column 64
    function visible_14 () : java.lang.Boolean {
      return permissions.CompletedPolicyTransactions
    }
    
    // 'visible' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 54, column 44
    function visible_17 () : java.lang.Boolean {
      return permissions.Account
    }
    
    // 'visible' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 57, column 62
    function visible_20 () : java.lang.Boolean {
      return permissions.canSeeNotes(policyPeriod)
    }
    
    // 'visible' attribute on TileRef at ArchivedPolicyPeriodPage.pcf: line 60, column 45
