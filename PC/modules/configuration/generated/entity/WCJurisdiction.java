...
public class WCJurisdiction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, entity.Modifiable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
   ...
   * reference date (see {@link gw.api.domain.CoverableAdapter#getReferenceDateInternal()} if
   * that is not null. Otherwise it will be calculated based on the Coverable's policy line and
   * state.
   */
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCJurisdictionInternal {
    ...
    @gw.internal.gosu.parser.ExtendedProperty
    public java.util.Date getReferenceDateInternal() {
      return ((gw.api.domain.CoverableAdapterWithReferenceDateInternalOverride)__getDelegateManager().getImplementation("gw.api.domain.CoverableAdapterWithReferenceDateInternalOverride")).getReferenceDateInternal();
    }
    ...
    public void setReferenceDateInternal(java.util.Date date) {
      ((gw.api.domain.CoverableAdapterWithReferenceDateInternalOverride)__getDelegateManager().getImplementation("gw.api.domain.CoverableAdapterWithReferenceDateInternalOverride")).setReferenceDateInternal(date);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAdapterWithReferenceDateInternalOverride", "gw.lob.wc.WCJurisdictionCoverableModifiableAdapter");
